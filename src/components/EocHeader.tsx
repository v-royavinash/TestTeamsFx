                ...
                {this.state.isCalloutVisible && (
                    ...
                    >
                        ...
                        <Text block variant="xLarge" className="info-titlelink">
                            {this.props.localeStrings.m365ChampCommunity}
                        </Text>
                        <Link href={constants.m365ChampionsUrl} target="_blank" className="info-link">
                            {constants.m365ChampionsUrl}
                        </Link>
                        <Text block variant="xLarge" className="info-titlelink">
                        ...
                        <Text block variant="small">
                            {this.props.localeStrings.latestVersion} : (pull latest version here)
                        </Text>
                        <Text block variant="xLarge" className="info-title">
                            ----
                        </Text>
                        ...
                        <Text block variant="small">
                            {this.props.localeStrings.overview} <a href={constants.m365EocUrl}>{this.props.localeStrings.msAdoptionHubLink}</a>
                        </Text>
                        <Link href={constants.m365EocUrl} target="_blank" className="info-link">
                            {constants.m365EocUrl}
                        </Link>
                        <Text block variant="small">
                            {this.props.localeStrings.solutionLink} <a href={constants.m365EocUrl}>GitHub</a>
                        </Text>
                        <Link href={constants.m365EocUrl} target="_blank" className="info-link">
                            {constants.m365EocUrl}
                        </Link>
